...
public class GTPlacerTypes {
    ...
    public static final TrunkPlacerType<RubberTrunkPlacer> RUBBER_TRUNK = registerTruckPlacer("rubber",
            RubberTrunkPlacer.CODEC);
    public static final FoliagePlacerType<RubberFoliagePlacer> RUBBER_FOLIAGE = registerFoliagePlacer("rubber",
            RubberFoliagePlacer.CODEC);

    public static <P extends TrunkPlacer> TrunkPlacerType<P> registerTruckPlacer(String pKey, Codec<P> pCodec) {
        return GTRegistries.register(BuiltInRegistries.TRUNK_PLACER_TYPE, GTCEu.id(pKey),
                ITrunkPlacerTypeAccessor.callCtor(pCodec));
    }

    public static <P extends FoliagePlacer> FoliagePlacerType<P> registerFoliagePlacer(String pKey, Codec<P> pCodec) {
        return GTRegistries.register(BuiltInRegistries.FOLIAGE_PLACER_TYPE, GTCEu.id(pKey),
                IFoliagePlacerTypeAccessor.callCtor(pCodec));
    }
