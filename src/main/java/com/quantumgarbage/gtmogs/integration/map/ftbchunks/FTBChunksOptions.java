...
public class FTBChunksOptions {
    ...
    public static void loadConfig() {
        ConfigUtil.loadDefaulted(CONFIG, ConfigUtil.LOCAL_DIR.resolve("gtmogs"), "gtmogs", "client-config.snbt");
    }

    public static void saveConfig() {
        CONFIG.save(ConfigUtil.LOCAL_DIR.resolve("gtmogs").resolve("client-config.snbt"));
    }
}
