...
public class OreVeinElementReader extends
    ...
    public ArrayList<RightClickOption> getRightClickOptions(final OreVeinElement element,
        ...
        rightClickOptions.add(new RightClickOption("button.gtmogs.toggle_waypoint.name", 0, target) {
        ...
        rightClickOptions
                .add((new RightClickOption("button.gtmogs.mark_as_depleted.name", rightClickOptions.size(), target) {
    ...
    public int getRightClickTitleBackgroundColor(OreVeinElement element) {
        return MapIntegrationUtils.getItemColor(element.getFirstMaterial());
    }
